...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='./dataset', type=str, help='path to ImageNet data')
    parser.add_argument('--record_results', default=True, action='store_true', 
    ...
    parser.add_argument('--scale_method', default='dynamic', type=str, 
                        help='Linear scale method or logarithmic base',
                        choices=['linear_mse', 'linear_minmax', 'log_2', 'log_sqrt2', 'dynamic'])
    parser.add_argument('--test_before_calibration', default=True, action='store_true')
    parser.add_argument('--hardware_approx', default=False, action='store_true',
    ...
    parser.add_argument('--search_method', default='tensor_wise', type=str, 
                        help='Search method for hyperparameters',
                        choices=['tensor_wise', 'layer_wise', 'block_wise'])
    
    # weight calibration parameters
    parser.add_argument('--calib_samples', default=1024, type=int, help='size of the calibration dataset') 
    parser.add_argument('--iters_w', default=20000, type=int, help='number of iteration for adaround') 
    parser.add_argument('--calib_lr', default=4e-5, type=float, help='learning rate for AdaRound')
    parser.add_argument('--weight', default=10000, type=float, 
    ...
    if args.arch.startswith('squeezenet'):
        ...
        cnn = EfficientNet.from_pretrained(args.arch)
    else:
    ...
    wq_params = {'n_bits': args.n_bits_w, 'channel_wise': args.channel_wise, 
                 'scale_method': args.scale_method, 'hardware_apprx': args.hardware_approx}
    ...
    if args.record_results:
        ...
        results = {
            ...
            'Search_hours': (search_end_time - start_time) / 3600,
            'Reconstruction_hours': (end_time - search_end_time) / 3600
            }
