...
def block_reconstruction(model: QuantModel, block: BaseQuantBlock, cali_data: torch.Tensor,
                         ...
                         lr: float = 4e-5, p: float = 2.0, multi_gpu: bool = False):
    """
    ...
    if not act_quant:
        ...
        scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=iters, eta_min=lr*0.3)
    ...
    loss_func = LossFunction(block, round_loss=loss_mode, weight=weight, max_count=iters, 
