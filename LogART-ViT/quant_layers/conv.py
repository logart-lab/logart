...
class PTQSLQuantConv2d(MinMaxQuantConv2d):
    ...
    def __init__(self, in_channels: int,
        ...
        self.w_quantizer = UniformQuantizer(n_bits = w_bit, symmetric = w_sym, channel_wise = True, scale_method = scale_method)
        self.a_quantizer = UniformQuantizer(n_bits = a_bit, symmetric = True, channel_wise = False)
        self.metric = metric
...
class PTQSLBatchingQuantConv2d(PTQSLQuantConv2d):
    def __init__(self, in_channels: int,
                 ...
                 eq_n = 100):
        super().__init__(in_channels, out_channels, kernel_size, stride, padding, dilation, groups, 
                         bias, padding_mode, mode, w_bit, a_bit, metric, search_round, scale_method, hardware_approx, w_sym, eq_n)
...
class AsymmetricallyBatchingQuantConv2d(PTQSLBatchingQuantConv2d):
    def __init__(self, in_channels: int,
                 ...
                 eq_n = 100):
        super().__init__(in_channels, out_channels, kernel_size, stride, padding, dilation, groups, 
                         bias, padding_mode, mode, w_bit, a_bit, metric, calib_batch_size, search_round, scale_method, hardware_approx, w_sym, eq_n)
