...
class LoaderGenerator():
    def __init__(self, root, train_batch_size=1, val_batch_size=1, num_workers=0, kwargs={}):
        self.root = root
    ...
    def calib_loader(self, num=1024, batch_size=32, in_memory=True):
...
class ViTImageNetLoaderGenerator(ImageNetLoaderGenerator):
    ...
    """
    def __init__(self, root, train_batch_size, val_batch_size, num_workers, kwargs={}):
        super().__init__(root, train_batch_size=train_batch_size, val_batch_size=val_batch_size, num_workers=num_workers, kwargs=kwargs)
